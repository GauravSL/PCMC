package com.example.pcmcdiwyang.scanners.face;
...
import com.example.pcmcdiwyang.scanners.face.customview.OverlayView;
import com.example.pcmcdiwyang.scanners.face.env.BorderedText;
import com.example.pcmcdiwyang.scanners.face.env.ImageUtils;
import com.example.pcmcdiwyang.scanners.face.env.Logger;
import com.example.pcmcdiwyang.scanners.face.tflite.SimilarityClassifier;
import com.example.pcmcdiwyang.scanners.face.tflite.TFLiteObjectDetectionAPIModel;
import com.example.pcmcdiwyang.scanners.face.tracking.MultiBoxTracker;
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  private AppCompatButton buttonCapture,buttonReset;
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    try {
      ...
      if (isVerification)
      detector.register("Match", Temp.face);
...
//        final int inHeight = transpose ? srcWidth : srcHeight;
  ...
  private void showAddFaceDialog(SimilarityClassifier.Recognition rec) {
    ...
    bitmapToSend = user.getCrop();
    Temp.bitmap = user.getCrop();
    setResult();
    ...
    //Button buttonDone = dialogLayout.findViewById(R.id.buttonDone);
    ivFace.setImageBitmap(user.getCrop());
    builder.setPositiveButton("OK", new DialogInterface.OnClickListener(){
      @Override
      public void onClick(DialogInterface dlg, int i) {
          String name = "Temp";
          detector.register(name, user);
          dlg.dismiss();
      }
    });
    ...
    ImageView ivUser = dialog.findViewById(R.id.ivUser);
    ivUser.setImageBitmap(user.getCrop());
...
//    }
  ...
  private void setResult(){
    ...
    returnIntent.putExtra("data",bitmapToSend);
    returnIntent.putExtra("result",isVerification);
    Temp.faceRecognitionSuccess = isVerification;
